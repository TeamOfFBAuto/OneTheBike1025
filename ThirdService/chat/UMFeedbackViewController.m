...
- (void)viewDidLoad {
    ...
    self.appkey=@"5423e48cfd98c58eed00664f";
    ...
    [_button_back addTarget:self action:@selector(backToPrevious) forControlEvents:UIControlEventTouchUpInside];
...
//    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"navigatdion_backGroud"] forBarMetrics: UIBarMetricsDefault];
